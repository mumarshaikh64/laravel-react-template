      ...
      <div className='page-content'>
        ...
        <div className='mt-4 w-full md:text-left text-center flex justify-center items-center flex-col'>
          ...
          <div className='mt-1'>
            ...
            />
            <button className='md:my-10 my-4 border py-2 px-4 font-[600] hover:bg-[#66bc43] hover:border-[#66bc43] hover:text-[#fff] border-1 border-[#1f3831]'>Search Practitioners</button>
          </div>
          ...
          <p className='py-2 md:px-[5rem] px-4 mb-2 font-[600] text-left w-full  text-[#1f3831]'> Looking for an UHPC Beauty Training Provider Click here - <Link to={"/pages/view-holistic/0"}><strong className='text-[#4091ca]'>UHPC Beauty</strong></Link></p>
