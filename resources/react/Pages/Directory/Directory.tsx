      ...
      <div className='page-content'>
        ...
        <div className='mt-4 md:text-left text-center w-full flex justify-center items-center flex-col'>
          ...
          <div className='mt-4'>
            ...
            />
            <button className='md:my-10 my-0 border py-2 px-4 font-[600] hover:bg-[#66bc43] hover:border-[#66bc43] hover:text-[#fff] border-1 border-[#1f3831]'>Search Practitioners</button>
          </div>
          <p className='md:py-2 py-6 md:px-[5rem] px-4 md:mt-4 mt-0 mb-2 font-[600]  text-[#1f3831]'>
            UHPC is the ONLY Global Holistic Therapy Certification Board for high- quality holistic and <Link to={"/pages/view-holistic/0"}><strong className='text-[#4091ca]'>beauty therapists</strong></Link> to receive trusted certification, so people who are seeking out professional practitioners can find the best.
          </p>
          ...
          <p className='py-2 md:px-[5rem] px-4 mb-2 font-[600] text-left w-full  text-[#1f3831]'> UHPC BEAUTY THERAPISTS - <Link to={"/user/auth"}><strong className='text-[#4091ca]'>Join Now</strong></Link></p>
          ...
          <div className='w-full flex justify-center' style={{
          ...
          }}>
            {
              mainContext?.allCategories == null ? <p>Please Wait...</p> : [
                ...
                return <div key={i} className="category bg-cover bg-center mx-2 rounded overflow-hidden shadow-xl my-2" style={{ backgroundImage: `url(${assetUrl}/${v.file_path})`, position: 'relative' }}>
                  <a id="holistic-spiritual" href="/directory/find-a-professional-practitioner/holistic-spiritual" className="text-white   absolute top-0 left-0 text-center w-full text-[14px] py-2 bg-[#4091ca]">
                    <span>{v.title}</span>
                  </a>
                </div>
              ...
              return (
                <div key={i} className="flex flex-col my-10 w-[32%] text-center shadow-lg hover:shadow-xl duration-300 mb-6 rounded-md bg-white relative group">
                  ...
                  <div className="avatar px-6 transform relative">
                    ...
                    {/* <span className="text-xs font-semibold uppercase px-4 py-0.5 bg-white shadow-md absolute -bottom-1 left-1/2 -translate-x-1/2 text-brand-600 border border-brand-500 border-solid rounded-lg">
                      insured
                    </span> */}
                  </div>
                  <div className="mt-8 px-6 text-left">
                    ...
                    <p className="pb-4 text-neutral-700">
                      ZennMore: A wellness and well-being platform to connect you with high quality online and in-person Well-being, Holistic Healing, and Fitness and Nutrition services. Our Well-being services include …
                    </p>
                  </div>
                  ...
                  <div className='my-4'>
                    <button className='my-2 border py-2 px-4 font-[600] hover:bg-[#4091ca] rounded hover:border-[#4091ca] hover:text-[#fff] border-1 border-[#1f3831]'>View Details</button>
                  </div>
                </div>
              )
            })}
              ...
              <div className="col-sm-12 columns">
                <div className="lead-text-large width-80pct-centered text-center text-white">
                  <p className='text-[25px] font-[600] px-[100px]'>
                    ...
                    <Link to="/pages/view-holistic/0" className=' py-2 text-[#4091ca]'> Apply Now </Link>for UHPC Membership.
                  </p>
                </div>
              </div>
            </div>
